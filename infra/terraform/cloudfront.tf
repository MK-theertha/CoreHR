...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  # SPA routing: any path not found in the S3 bucket (a client-side route
  # like /employees/42) falls back to index.html and lets React Router
  # handle it, instead of surfacing S3's raw 403/404.
